...
/**
 * Creates the pooled HTTP transports used by the external consultation and external-exit adapters.
 *
 * <p>Pool and timeout values are explicit so a CRAFT audit can resolve them from repository evidence instead
 * of relying on framework defaults.</p>
 */
@Configuration
