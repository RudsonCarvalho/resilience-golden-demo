package io.github.rudsoncarvalho.craft.infra.client.catalog;
 ...
 *
 * <p>This is the CRAFT external-consultation boundary. Timeout and pooling are configured by shared HTTP
 * infrastructure, while circuit breaking, bounded retry and fallback are attached to this interaction point.</p>
 */
@Component
